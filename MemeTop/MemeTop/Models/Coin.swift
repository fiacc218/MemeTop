...
let defaultWatchlist: [WatchlistItem] = [
    WatchlistItem(id: "bitcoin", symbol: "BTC", name: "Bitcoin",
                  contract: nil, chain: nil, notes: nil, source: .coingecko),
    WatchlistItem(id: "ethereum", symbol: "ETH", name: "Ethereum",
                  contract: nil, chain: nil, notes: nil, source: .coingecko),
    WatchlistItem(id: "solana", symbol: "SOL", name: "Solana",
                  contract: nil, chain: nil, notes: nil, source: .coingecko),
    WatchlistItem(id: "dogecoin", symbol: "DOGE", name: "Dogecoin",
                  contract: nil, chain: nil, notes: nil, source: .coingecko),
    WatchlistItem(id: "pepe", symbol: "PEPE", name: "Pepe",
                  contract: nil, chain: nil, notes: nil, source: .coingecko),
]
